  ...
  return (
    <section className="flex flex-col justify-center items-center gap-16 pt-36 text-center">
      <h3 className="text-white text-4xl sm:text-5xl md:text-7xl font-light block">
        ...
        <span className="">
          <span>with</span> <span className="font-semibold text-amber-700">Rustic</span>
          <span >Recipes</span>
        </span>
      </h3>
      <p className="max-w-[300px] sm:max-w-[500px] md:max-w-[700px] text-[#fafafac3] text-[16px] pt-10">
        Welcome to Rustic Recipes, the ultimate destination for food enthusiasts
        ...
        satisfaction, and make every meal a masterpiece with Rustic Recipes.
      </p>
    </section>
  );
};
