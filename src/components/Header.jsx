      ...
      <div className="navbar m-auto backdrop-blur-md justify-between fixed top-0 z-50">
        <div className="navbar m-auto justify-between max-w-7xl">
          <div className="navbar-start w-auto">
            ...
            <Link to="/favorites" className="text-white text-lg hover:text-amber-500">
  ❤️ Favorites
</Link>
          </div>
            ...
            >
              <span className="relative flex">
                ...
                <span className="flex flex-col justify-center items-center relative">
                  <span className="text-amber-700 absolute z-10 bottom-3 sm:bottom-5 -left-11">
                  ustic  
                  </span>
                  <span className="absolute z-30 top-[12px] sm:top-[24px] -left-11">
                  ecipes
                  </span>
                </span>
              </span>
